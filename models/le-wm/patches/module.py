...
class Module(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        enable_profiling = False                 ## can be changed here for more profiling !                
        ...
        with profiler_context as prof:
            ...
            with record_function("resolve_optimizers"):
            ...
            with record_function("after_manual_backward"):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        from contextlib import nullcontext
        enable_profiling = batch_idx % 1000 == 0                ## can be changed here for more profiling !                
